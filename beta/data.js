...
const BOARDS = {
  bm1000: {
    ...
    hotspots: [
      { grip: 'jug', x: 15, y: 23.6, hx: 15.0, hy: 23.6, hw: 10, hh: 6, surface: true },
      { grip: 'jug', x: 85, y: 23.6, hx: 85.0, hy: 23.6, hw: 10, hh: 6, surface: true },
      { grip: 'sloper_medium', x: 29.85, y: 30.9, hx: 29.85, hy: 30.9, hw: 10, hh: 6, surface: true },
      { grip: 'sloper_medium', x: 70.15, y: 30.9, hx: 70.15, hy: 30.9, hw: 10, hh: 6, surface: true },
      { grip: 'sloper_easy', x: 43.55, y: 28.3, hx: 43.55, hy: 28.3, hw: 10, hh: 6, surface: true },
      { grip: 'sloper_easy', x: 56.45, y: 28.3, hx: 56.45, hy: 28.3, hw: 10, hh: 6, surface: true },
      { grip: 'edge_xsmall', x: 14, y: 37.6, hx: 11.95, hy: 36.63, hw: 15.01, hh: 10.47 },
      { grip: 'edge_xsmall', x: 86, y: 37.6, hx: 88.38, hy: 37.21, hw: 13.58, hh: 11.05 },
      { grip: 'edge3', x: 44.3, y: 37.3, hx: 44.26, hy: 37.5, hw: 10.44, hh: 10.47 },
      { grip: 'edge3', x: 55.7, y: 37.3, hx: 57.25, hy: 37.5, hw: 10.31, hh: 10.47 },
      { grip: 'edge_medium', x: 10.85, y: 51.4, hx: 10.84, hy: 51.02, hw: 15.14, hh: 9.59 },
      { grip: 'edge_medium', x: 89.15, y: 51.4, hx: 89.62, hy: 51.31, hw: 13.97, hh: 9.59 },
      { grip: 'pocket2_deep', x: 75.6, y: 52, hx: 76.63, hy: 51.16, hw: 7.31, hh: 9.88 },
      { grip: 'pocket2_deep', x: 24.4, y: 52, hx: 24.54, hy: 51.02, hw: 7.57, hh: 9.59 },
      { grip: 'pocket3_deep', x: 34, y: 52.5, hx: 35.7, hy: 51.16, hw: 10.84, hh: 9.88 },
      { grip: 'pocket3_deep', x: 66, y: 52.5, hx: 65.4, hy: 51.31, hw: 10.7, hh: 9.59 },
      { grip: 'edge_large', x: 50, y: 50.7, hx: 50.52, hy: 51.31, hw: 15.14, hh: 9.59 },
      { grip: 'edge_small', x: 80.9, y: 67.4, hx: 80.94, hy: 68.68, hw: 14.62, hh: 9.45 },
      { grip: 'edge_small', x: 19.1, y: 67.4, hx: 20.04, hy: 68.68, hw: 15.01, hh: 9.45 },
      { grip: 'pocket2', x: 67.2, y: 68.3, hx: 67.66, hy: 68.68, hw: 6.33, hh: 9.45 },
      { grip: 'pocket2', x: 32.8, y: 68.3, hx: 33.81, hy: 68.68, hw: 7.18, hh: 9.45 },
      { grip: 'pocket3', x: 56.45, y: 68.6, hx: 57.28, hy: 68.68, hw: 10.12, hh: 9.45 },
      { grip: 'pocket3', x: 43.55, y: 68.6, hx: 44.81, hy: 68.68, hw: 10.25, hh: 9.45 },
    ],
  },
  bm2000: {
    ...
    hotspots: [
      { grip: 'sloper_easy', x: 43.25, y: 25.9, hx: 43.25, hy: 25.9, hw: 10, hh: 6, surface: true },
      { grip: 'sloper_easy', x: 56.75, y: 25.9, hx: 56.75, hy: 25.9, hw: 10, hh: 6, surface: true },
      { grip: 'sloper_medium', x: 28.55, y: 30.3, hx: 28.55, hy: 30.3, hw: 10, hh: 6, surface: true },
      { grip: 'sloper_medium', x: 71.45, y: 30.3, hx: 71.45, hy: 30.3, hw: 10, hh: 6, surface: true },
      { grip: 'sloper_hard', x: 12, y: 28.7, hx: 13.5, hy: 28.7, hw: 10, hh: 6, surface: true },
      { grip: 'sloper_hard', x: 88, y: 28.7, hx: 86.5, hy: 28.7, hw: 10, hh: 6, surface: true },
      { grip: 'edge_medium', x: 12.75, y: 50.4, hx: 13.84, hy: 49.42, hw: 12.27, hh: 8.14 },
      { grip: 'edge_medium', x: 87.25, y: 50.4, hx: 87.99, hy: 49.42, hw: 11.75, hh: 8.14 },
      { grip: 'mono', x: 22.9, y: 49.7, hx: 23.24, hy: 48.26, hw: 3.39, hh: 8.72 },
      { grip: 'mono', x: 77.1, y: 49.7, hx: 78.92, hy: 47.97, hw: 3.26, hh: 8.72 },
      { grip: 'pocket2_offset', x: 29.6, y: 48.8, hx: 30.16, hy: 49.42, hw: 7.05, hh: 8.14 },
      { grip: 'pocket2_offset', x: 70.4, y: 48.8, hx: 72.19, hy: 49.42, hw: 7.05, hh: 8.14 },
      { grip: 'pocket2', x: 38.35, y: 49.3, hx: 39.1, hy: 49.42, hw: 7.18, hh: 8.14 },
      { grip: 'pocket2', x: 61.65, y: 49.3, hx: 63.25, hy: 49.42, hw: 6.92, hh: 8.14 },
      { grip: 'edge_large', x: 50, y: 49.5, hx: 51.24, hy: 49.42, hw: 13.19, hh: 8.14 },
      { grip: 'edge_xsmall', x: 13.75, y: 67.1, hx: 15.08, hy: 66.57, hw: 12.14, hh: 8.72 },
      { grip: 'edge_xsmall', x: 86.25, y: 67.1, hx: 86.88, hy: 66.57, hw: 11.62, hh: 8.72 },
      { grip: 'mono_small', x: 23.05, y: 68.2, hx: 24.2, hy: 66.4, hw: 3.4, hh: 8.7 },
      { grip: 'mono_small', x: 76.95, y: 68.2, hx: 77.9, hy: 66.4, hw: 3.4, hh: 8.7 },
      { grip: 'pocket2_small', x: 29.75, y: 67.4, hx: 30.74, hy: 66.57, hw: 6.92, hh: 8.72 },
      { grip: 'pocket2_small', x: 70.25, y: 67.4, hx: 71.48, hy: 66.57, hw: 6.66, hh: 8.72 },
      { grip: 'pocket2_small', x: 38.1, y: 68, hx: 38.84, hy: 66.57, hw: 6.66, hh: 8.72 },
      { grip: 'pocket2_small', x: 61.9, y: 68, hx: 63.38, hy: 66.57, hw: 6.66, hh: 8.72 },
      { grip: 'pocket3', x: 43.65, y: 37, hx: 44.91, hy: 37.06, hw: 9.4, hh: 7.85 },
      { grip: 'pocket3_small', x: 56.35, y: 37, hx: 57.57, hy: 37.06, hw: 9.4, hh: 7.85 },
      { grip: 'edge_small', x: 50, y: 69.7, hx: 51.17, hy: 66.57, hw: 14.88, hh: 8.72 },
    ],
  },
};
