...
const BOARDS = {
  bm1000: {
    ...
    hotspots: [
      { grip: 'jug', x: 14.9, y: 23.6 },
      { grip: 'jug', x: 84.9, y: 23.6 },
      { grip: 'sloper_medium', x: 28.9, y: 30.9 },
      { grip: 'sloper_medium', x: 69.2, y: 30.9 },
      { grip: 'sloper_easy', x: 44.6, y: 28.3 },
      { grip: 'sloper_easy', x: 57.5, y: 28.3 },
      { grip: 'edge_xsmall', x: 13.9, y: 37.6 },
      { grip: 'edge_xsmall', x: 85.9, y: 37.6 },
      { grip: 'edge3', x: 46.1, y: 37.3 },
      { grip: 'edge3', x: 57.5, y: 37.3 },
      { grip: 'edge_medium', x: 12.4, y: 51.4 },
      { grip: 'edge_medium', x: 90.7, y: 51.4 },
      { grip: 'pocket2_deep', x: 76.5, y: 52 },
      { grip: 'pocket2_deep', x: 25.3, y: 52 },
      { grip: 'pocket3_deep', x: 36.2, y: 52.5 },
      { grip: 'pocket3_deep', x: 68.2, y: 52.5 },
      { grip: 'edge_large', x: 50.2, y: 50.7 },
      { grip: 'edge_small', x: 82.1, y: 67.4 },
      { grip: 'edge_small', x: 20.3, y: 67.4 },
      { grip: 'pocket2', x: 68.9, y: 68.3 },
      { grip: 'pocket2', x: 34.5, y: 68.3 },
      { grip: 'pocket3', x: 57.5, y: 68.6 },
      { grip: 'pocket3', x: 44.6, y: 68.6 },
    ],
  },
  bm2000: {
    ...
    hotspots: [
      { grip: 'sloper_easy', x: 43.3, y: 25.9 },
      { grip: 'sloper_easy', x: 56.8, y: 25.9 },
      { grip: 'sloper_medium', x: 29.1, y: 30.3 },
      { grip: 'sloper_medium', x: 72, y: 30.3 },
      { grip: 'sloper_hard', x: 11.4, y: 28.7 },
      { grip: 'sloper_hard', x: 87.4, y: 28.7 },
      { grip: 'edge_medium', x: 13.9, y: 50.4 },
      { grip: 'edge_medium', x: 88.4, y: 50.4 },
      { grip: 'mono', x: 23.8, y: 49.7 },
      { grip: 'mono', x: 78, y: 49.7 },
      { grip: 'pocket2_offset', x: 29.9, y: 48.8 },
      { grip: 'pocket2_offset', x: 70.7, y: 48.8 },
      { grip: 'pocket2', x: 38.8, y: 49.3 },
      { grip: 'pocket2', x: 62.1, y: 49.3 },
      { grip: 'edge_large', x: 50.9, y: 49.5 },
      { grip: 'edge_xsmall', x: 14.4, y: 67.1 },
      { grip: 'edge_xsmall', x: 86.9, y: 67.1 },
      { grip: 'mono_small', x: 24.6, y: 68.2 },
      { grip: 'mono_small', x: 78.5, y: 68.2 },
      { grip: 'pocket2_small', x: 31.7, y: 67.4 },
      { grip: 'pocket2_small', x: 72.2, y: 67.4 },
